({
    ...
    handleClick : function(component, event, helper){
        try{
            ...
            document.addEventListener("keydown", function(event) {
                ...
                if(event.which==13){
                    if(component.get("v.condition2")>0){
                        var data2to=component.get("v.pillValueListCc");
                        data2to.pop();
                        component.set("v.pillValueListCc",data2to);
                        component.set("v.condition2",0);
                    }
                    if(component.get("v.condition3")>0){
                        var data2to=component.get("v.pillValueListBcc");
                        data2to.pop();
                        component.set("v.pillValueListBcc",data2to);
                        component.set("v.condition3",0);
                    }
                    ...
                    if(component.get("v.condition")<1)
                    {
                        ...
                        var data1to={'id':'','Name':inputto,'Email':inputto};
                        var data2to=component.get("v.pillValueList");
                        data2to.push(data1to);
                        component.set("v.pillValueList",data2to);
    ...
    handleClickCc : function(component, event, helper){
        try{
            ...
            document.addEventListener("keydown", function(event) {
                if(event.which==13){
                    if(component.get("v.condition")>0){
                        var data2to=component.get("v.pillValueList");
                        data2to.pop();
                        component.set("v.pillValueList",data2to);
                        component.set("v.condition",0);
                    ...
                    if(component.get("v.condition2")<1)
                    {
                        component.set("v.condition2",1);
                        var inputcc=document.getElementById('enter-searchcc').value;
                        var datacc={'id':'','Name':inputcc,'Email':inputcc};
                        var data2cc=component.get("v.pillValueListCc");
                        data2cc.push(datacc);
                        component.set("v.pillValueListCc",data2cc);
        ...
        try{
            ...
            document.addEventListener("keydown", function(event) {
                if(event.which==13){
                    ...
                    if(component.get("v.condition3")<1)
                    {
                        component.set("v.condition3",1);
                        var inputbcc=document.getElementById('enter-searchbcc').value;
                        var databcc={'id':'','Name':inputbcc,'Email':inputbcc};
                        var data2bcc=component.get("v.pillValueListBcc");
                        data2bcc.push(databcc);
                        component.set("v.pillValueListBcc",data2bcc);
    ...
    onCheck : function(component, event, helper)
    {
        try
        {
            ...
            try
            {
                ...
                if(fileValueObj.FileType == 'txt'){
                    
                    fileValueObj.fileIcon ='doctype:txt';
                }
    ...
    showownedby :function(component,event,helper){
